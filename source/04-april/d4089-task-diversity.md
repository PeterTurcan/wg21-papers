...
The author developed and maintains [Capy](https://github.com/cppalliance/capy)<sup>[32]</sup> and [Corosio](https://github.com/cppalliance/corosio)<sup>[33]</sup> and believes coroutine-native I/O is a practical foundation for networking in C++.
