...
[P2469R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p2469r0.pdf)<sup>[6]</sup> (2021) described the same event:
...
| SG1 Redmond                                                                 | 2014 | "Start with Mysen's proposal" - directed to unify ([N4199](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2014/n4199.html)<sup>[11]</sup>) | Straw poll, no prototype    |
| [P0443R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0443r0.html)<sup>[1]</sup>                         | 2016 | "Unifies three separate executor design tracks"     | No prototype, no experiment |
| [P0761R2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p0761r2.pdf)<sup>[13]</sup>                        | 2018 | Design document published                           | No analysis of domain loss  |
| [P0443R14](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p0443r14.html)<sup>[3]</sup>                      | 2020 | Final unified proposal                              | Never deployed as unified   |
...
Kohlhoff wrote in [P0285R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0285r0.html)<sup>[14]</sup> (2016):
...
The Executors Design Document, [P0761R2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p0761r2.pdf)<sup>[13]</sup> (2018), argued:
...
[P2453R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2022/p2453r0.html)<sup>[18]</sup>, "2021 October Library Evolution Poll Outcomes," documents the following poll:
...
[P2400R2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p2400r2.html)<sup>[16]</sup> stated: "we had consensus that we want to proceed with P2300 instead of P0443." The committee leaned toward unification even when consensus on the "grand unified model" premise was not achieved.
...
| "P0443 represents a significant body of compromise and consensus seeking"                                  | [P1791R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1791r0.html)<sup>[12]</sup> (2019)      | The breadth of participation is documented (Google, NVIDIA, Sandia, Codeplay, Facebook, etc.). More than 100 papers. This is evidence of effort. It is not evidence that the unification preserved domain semantics.                                                                                                                                                                                  |
| "some reduction in usability, due to the increased complexity of the unified interface"                    | [P2469R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p2469r0.pdf)<sup>[6]</sup> (2021)       | The authors of the unified proposal acknowledge the cost. No measurement of the magnitude.                                                                                                                                                                                                                                                                                                           |
...
- [N1925](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2005/n1925.pdf)<sup>[21]</sup> (2005): first networking proposal.
- Networking TS published as ISO TS (2018).
- Herb Sutter, San Diego 2018<sup>[22]</sup>: executors "design approved for C++20."
- [P1256R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p1256r0.html)<sup>[23]</sup> (Vollmann, 2018): "SG1 has decided that the Networking TS should not be merged into the C++ working paper before executors go in."
- [P2130R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p2130r0.pdf)<sup>[24]</sup> (Prague 2020 minutes): Pablo Halpern asks "How blocked is networking on the executors wording process?"
- [P2464R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p2464r0.html)<sup>[19]</sup> (Voutilainen, 2021): "Stop spending energy on standardizing the Networking TS for C++23."
- 2026: networking is not in the C++ standard. Twenty-one years from [N1925](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2005/n1925.pdf)<sup>[21]</sup>.
...
| -------------------------------------------------------------- | ---- | ------------------------------------------------------------------------------------------- |
| [P0113R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0113r0.html)<sup>[26]</sup>           | 2015 | First-class: `defer` = "continuation of the caller"                                         |
| [P0688R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0688r0.html)<sup>[27]</sup>           | 2017 | Demoted to `prefer(is_continuation)` hint                                                   |
| [P0761R2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p0761r2.pdf)<sup>[13]</sup>           | 2018 | Optional property, framed as "may execute more efficiently"                                 |
| [P1525R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1525r0.pdf)<sup>[28]</sup>           | 2019 | Pure work language. One incidental mention of "continuation"                                |
| [P1660R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1660r0.pdf)<sup>[29]</sup>           | 2019 | "Eagerly submits work." Executor = "factory for execution agents"                           |
| [P0443R14](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p0443r14.html)<sup>[3]</sup>         | 2020 | Section heading: "Executors Execute Work." Continuation property gone                       |
| [P2464R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p2464r0.html)<sup>[19]</sup>           | 2021 | "Work-submitter." No `async_result`, no [N3747](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3747.pdf)<sup>[30]</sup>    |

Each step was locally reasonable.

### 6.2 The Two Stages

The API that [P0443R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0443r0.html)<sup>[1]</sup> inherited from three independent models had a large surface: `execute`, `post`, `defer`, `sync_execute`, `async_execute`, `async_post`, `async_defer`, `bulk_execute`, and their variants. The simplification effort that reduced this surface addressed real complexity. The transition from continuation-scheduling primitives to a work-submission primitive happened in two stages.

**Stage 1: `dispatch`/`post`/`defer` become `.execute()` plus a property hint.**

[P0688R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0688r0.html)<sup>[27]</sup> (Kohlhoff, Hoberock, Mysen, Brown, 2017) replaced the three separate functions with a single `.execute()` function. The continuation semantics that `defer` had carried as a first-class operation were converted into an optional preference: `require(exec, oneway).prefer(is_continuation).execute(task)`. The paper's stated rationale:
...
[P0688R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0688r0.html)<sup>[27]</sup> does not analyze what is lost by converting three continuation-scheduling primitives into a single work-submission primitive with an optional property. It does not discuss the implications for networking. [P0443R2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0443r2.html)<sup>[31]</sup> confirmed: "Applied the simplification proposed by paper P0688." That is the first stage.

**Stage 2: All interface-changing properties eliminated.**

Three papers drove the second stage:

- [P1525R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1525r0.pdf)<sup>[28]</sup> (Niebler, Shoop, Baker, Howes, 2019), "One-Way execute is a Poor Basis Operation." Analyzes `execute` purely as work submission. Uses the phrase "work submission" throughout. Contains one incidental mention of "continuation" in the context of a deadline executor. Does not discuss the original continuation framing of `dispatch`/`post`/`defer`. Does not mention `async_result` or [N3747](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3747.pdf)<sup>[30]</sup>.
...
[P0285R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0285r0.html)<sup>[14]</sup> argued: "we want to be able to have a single thread pool object that can be used for all of the above use cases."
...
A: [P0113R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0113r0.html)<sup>[26]</sup> (Kohlhoff, 2015) defined `defer` as scheduling "a continuation of the caller." Section 6.1 documents every paper in the chain. The continuation framing is the original framing. The work framing is the replacement.
...
[1] [P0443R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0443r0.html) - "A Unified Executors Proposal for C++" (Jared Hoberock, Michael Garland, Chris Kohlhoff, Chris Mysen, Carter Edwards, 2016).
...
[3] [P0443R14](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p0443r14.html) - "A Unified Executors Proposal for C++" (Jared Hoberock et al., 2020).
...
[6] [P2469R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p2469r0.pdf) - "Response to P2464: The Networking TS is baked, P2300 Sender/Receiver is not" (Christopher Kohlhoff, Jamie Allsop, Vinnie Falco, Richard Hodges, Klemens Morgenstern, 2021).

[7] [N4046](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2014/n4046.pdf) - "Executors and Asynchronous Operations" (Christopher Kohlhoff, 2014).

[8] [N4406](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/n4406.pdf) - "Integrating Executors with Parallel Algorithm Execution" (Jared Hoberock, Michael Garland, Olivier Giroux, 2015).

[9] [P0058](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0058r1.pdf) - "An Interface for Abstracting Execution" (Jared Hoberock, Michael Garland, Olivier Giroux, 2015).

[10] [N4414](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/n4414.pdf) - "Executors and Schedulers Revision 5" (Chris Mysen, 2015).

[11] [N4199](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2014/n4199.html) - "Minutes of Sept. 4-5, 2014 SG1 meeting in Redmond, WA" (Hans-J. Boehm, 2014).

[12] [P1791R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1791r0.html) - "Evolution of the P0443 Unified Executors Proposal to accommodate new requirements" (Christopher Kohlhoff, Jamie Allsop, 2019).

[13] [P0761R2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p0761r2.pdf) - "Executors Design Document" (Jared Hoberock, Michael Garland, Chris Kohlhoff, Chris Mysen, Carter Edwards, Gordon Brown, Michael Wong, 2018).

[14] [P0285R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0285r0.html) - "Using customization points to unify executors" (Christopher Kohlhoff, 2016).

[15] [P2403R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p2403r0.pdf) - "Presentation on P2300 - std::execution" (2021).

[16] [P2400R2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p2400r2.html) - "Library Evolution Report: 2021-06-01 to 2021-09-20" (Bryce Adelstein Lelbach, 2021).
...
[18] [P2453R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2022/p2453r0.html) - "2021 October Library Evolution Poll Outcomes" (Bryce Adelstein Lelbach, Fabio Fracassi, Ben Craig, 2022).

[19] [P2464R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2021/p2464r0.html) - "Ruminations on networking and executors" (Ville Voutilainen, 2021).
...
[23] [P1256R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p1256r0.html) - "Executors Should Go To A TS" (Detlef Vollmann, 2018).

[24] [P2130R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p2130r0.pdf) - "WG21 2020-02 Prague Record of Discussion" (Nina Ranns, 2020).

[25] [P1658R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1658r0.pdf) - "Suggestions for Consensus on Executors" (Jared Hoberock, Bryce Adelstein Lelbach, 2019).

[26] [P0113R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0113r0.html) - "Executors and Asynchronous Operations, Revision 2" (Christopher Kohlhoff, 2015).

[27] [P0688R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0688r0.html) - "A Proposal to Simplify the Unified Executors Design" (Chris Kohlhoff, Jared Hoberock, Chris Mysen, Gordon Brown, 2017).

[28] [P1525R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1525r0.pdf) - "One-Way execute is a Poor Basis Operation" (Eric Niebler, Kirk Shoop, Lewis Baker, Lee Howes, 2019).

[29] [P1660R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1660r0.pdf) - "A Compromise Executor Design Sketch" (Jared Hoberock, Michael Garland, Bryce Adelstein Lelbach, Micha&lstrok; Dominiak, Eric Niebler, Kirk Shoop, Lewis Baker, Lee Howes, David S. Hollman, Gordon Brown, 2019).

[30] [N3747](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3747.pdf) - "A Universal Model for Asynchronous Operations" (Christopher Kohlhoff, 2013).

[31] [P0443R2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0443r2.html) - "A Unified Executors Proposal for C++" (Jared Hoberock, Michael Garland, Chris Kohlhoff, Chris Mysen, Carter Edwards, Gordon Brown, 2017).

[32] [P0443R11](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p0443r11.html) - "A Unified Executors Proposal for C++" (Jared Hoberock, Michael Garland, Chris Kohlhoff, Chris Mysen, Carter Edwards, Gordon Brown, David Hollman, Lee Howes, Kirk Shoop, Eric Niebler, 2019).

[33] [P1194R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p1194r0.html) - "The Compromise Executors Proposal: A lazy simplification of P0443" (Lee Howes, Eric Niebler, Kirk Shoop, Bryce Lelbach, D. S. Hollman, 2018).
